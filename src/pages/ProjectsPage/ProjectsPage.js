    ...
    return (
        <article className='project-card'>
            <div className="row project-container">
                <div className="col-md-6 order-1 order-md-0 mb-5 mb-md-0 text-col d-flex flex-column justify-content-center">
                    <div className="project-info">
                        ...
                        <div className="btns">
                            ...
                            <a href="#" className='d-block d-sm-inline mt-4 mt-sm-0 ms-sm-4 '><img src="./images/huawei-gallery.jpg" alt="/" className='store-img rounded' /></a>
                        </div>
                    </div>
                </div>
                <div className="col-md-6 order-0 order-md-1 mt-5 mt-md-0 img-col text-center">
